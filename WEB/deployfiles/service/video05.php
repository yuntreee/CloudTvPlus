                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mb-5">
                                <h1 class="fw-bolder"><br>'Dynamite' MV (B-Side) Reaction</h1>
                                <p class="lead fw-normal text-muted mb-0">빌보드 Hot 100 1위! BTS 디지털싱글 Dynamite / 코믹스러운 B-Side 뮤직비디오를 멤버가 직접 리액션 </p>
                            </div>
                        </div>
                    </div>                                                        
                </div>
